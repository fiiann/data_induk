			...
			<div class="panel-body">
				<div class="table-responsive">
					<table class="table table-striped table-bordered table-hover">
						...
						<?php
							// Assign a query
							$query = "SELECT * FROM anggota ORDER BY nama LIMIT 10";
							// Execute the query
							$result = $con->query( $query );
							if(!$result){
							...
							while($row = $result->fetch_object()){
								...
								echo "<td>
										<a href='detail_mahasiswa.php?nim=".$row->nim."'><i class='fa fa-edit'></i></a>&nbsp;
										<a href='edit_mahasiswa.php?nim=".$row->nim."'><i class='fa fa-edit'></i></a>&nbsp;
										<a href='delete_mahasiswa.php?nim=".$row->nim."'><i class='fa fa-trash-o'></i></a>&nbsp;
										</td>";
								echo "</tr>";
							}
						?>
